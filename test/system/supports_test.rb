...
class SupportsTest < ApplicationSystemTestCase
  ...
  test "creating a Support" do
    ...
    fill_in "Description", with: @support.description
    fill_in "Servicetag", with: @support.servicetag
    fill_in "Text", with: @support.text
    fill_in "Typeofsupport", with: @support.typeofsupport
